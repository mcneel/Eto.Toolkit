...
namespace Scintilla
{
    ...
    public class ScintillaControl : Control
    {
        ...
        private static unsafe byte[] GetBytes(string text, System.Text.Encoding encoding, bool zeroTerminated)
        {
        ...
        private IntPtr DirectMessage(IntPtr sciPtr, int msg, IntPtr wParam, IntPtr lParam)
        {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                if (moduleHandle == IntPtr.Zero)
                {
                    ...
                    //var path = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "scintilla", "SciLexer.dll");
                    ...
                    //this.scix.ScintillaHandle = moduleHandle; // SciPointer;
                    //this.scix.ScintillaHandle = SciPointer;
                    //this.scix.DirectFunction = directFunction;
                }
